...
/***/ function(module, exports, __webpack_require__) {
	...
	var gameLogic = __webpack_require__(15);
	...
	$(function () {
	  ...
	  $('.cell').on('click', function () {
	    if (gameLogic.checkValidClick(this.id) === false) {
	      return;
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onSignOut = function onSignOut(event) {
	  var data = getFormFields(this);
	  event.preventDefault();
	  api.signOut(data).then(ui.signOutSuccess).catch(ui.signOutSuccess);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var gamesApi = __webpack_require__(13);
	var gamesUi = __webpack_require__(14);
	var store = __webpack_require__(10);

	var onGetGames = function onGetGames() {
	  event.preventDefault();
	  gamesApi.getGames().then(function (result) {
	    gamesUi.onGetGamesSuccess(result);
	  }).catch(gamesUi.onGetGamesError);
	};

	var onCreateGame = function onCreateGame(event) {
	  gamesApi.createGame().then(function (result) {
	...
	var onUpdateGame = function onUpdateGame(index, value, over) {
	  gamesApi.updateGame(index, value, over).then(gamesUi.onUpdateGameSuccess).catch(gamesUi.onUpdateGameFailure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	var checkValidClick = function checkValidClick(cellId) {
	 ...
	 */
	var incrementTurnCount = function incrementTurnCount() {
	  turnCount++;
	  if (turnCount % 2 === 0) {
	    currPlayer = 'X';
	  } else {
	 ...
	 */
	var insertIntoGameBoard = function insertIntoGameBoard(cellId) {
	 ...
	 */
	var checkGameOutcome = function checkGameOutcome() {
	  if (turnCount < 5) {
	    return;
	  }

	  if (gameBoard[0] === currPlayer && gameBoard[1] === currPlayer && gameBoard[2] === currPlayer || gameBoard[3] === currPlayer && gameBoard[4] === currPlayer && gameBoard[5] === currPlayer || gameBoard[6] === currPlayer && gameBoard[7] === currPlayer && gameBoard[8] === currPlayer || gameBoard[0] === currPlayer && gameBoard[3] === currPlayer && gameBoard[6] === currPlayer || gameBoard[1] === currPlayer && gameBoard[4] === currPlayer && gameBoard[7] === currPlayer || gameBoard[2] === currPlayer && gameBoard[5] === currPlayer && gameBoard[8] === currPlayer || gameBoard[0] === currPlayer && gameBoard[4] === currPlayer && gameBoard[8] === currPlayer || gameBoard[2] === currPlayer && gameBoard[4] === currPlayer && gameBoard[6] === currPlayer) {
	    renderGameOver('win');
	  } else if (turnCount === 9) {
	    renderGameOver('draw');
	  }
	 ...
	 */
	var renderGameOver = function renderGameOver(outcome) {
	  $('.gameStateActive').toggleClass('gameStateActive gameStateInactive');
	...
	var updateOutcomeText = function updateOutcomeText(message) {
	 ...
	 */
	var updateGameState = function updateGameState(cellId) {
	  var over = false;
	  if ($('#grid').hasClass('gameStateInactive')) {
	    over = true;
	  }
	...
	module.exports = {
	  startGame: startGame,
	  checkValidClick: checkValidClick,
	  incrementTurnCount: incrementTurnCount,
	  insertIntoGameBoard: insertIntoGameBoard,
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "* {\n  box-sizing: border-box;\n}\n\nbody {\n  text-align: center;\n  color: #fff;\n  font-family: sans-serif;\n  user-select: none;\n}\n\nheader {\n  font-size: 50px;\n  width: 620px;\n  margin: 0 auto;\n  height: 50px;\n  padding: 10px 0;\n}\n\n.title {\n  float: left;\n}\n\n#grid {\n  width: 460px;\n  height: 460px;\n  margin: 0 auto;\n  background: black;\n  position: relative;\n}\n\n/*\nparent: flexbox itself\nitems inside: flex items\n*/\n\n.cells {\n  position: absolute;\n  display: flex;\n  flex-direction: row;\n  flex-wrap: wrap;\n  align-items: flex-end;\n}\n\n.cell {\n  width: 150px;\n  height: 150px;\n  padding-top: 5px;\n  margin-right: 5px;\n  margin-bottom: 5px;\n  background: white;\n  line-height: 1;\n  /*line-height is % of font size*/\n  font-size: 100px;\n  font-family: 'Indie Flower', cursive;\n}\n\n.cell p {\n  font-size: 60px;\n  padding-top: 45px;\n  font-family: 'Sue Ellen Francisco', cursive;\n}\n\n.cell:nth-child(3n) {\n  margin-right: 0;\n}\n\n#startButton {\n  display: block;\n  border: none;\n  background-color: #f7e3f3;\n  font-size: 30px;\n  border-radius: 6px;\n  margin: auto;\n  font-family: 'Indie Flower', cursive;\n  /*padding-top: 0.75em;*/\n  outline: none;\n}\n\n.signInErrorMessage {\n  display: inline-block;\n  font-family: 'Sue Ellen Francisco', cursive;\n  font-size: 20px;\n}\n\n.signUpErrorMessage {\n  display: inline-block;\n  font-family: 'Sue Ellen Francisco', cursive;\n  font-size: 20px;\n}\n\n.hidden {\n  visibility: hidden\n}\n\n.outcomeText {\n  font-family: 'Indie Flower', cursive;\n  font-size: 47px;\n  padding-top: 0.2em;\n}\n\n.gameHistoryContainer {\n  font-family: 'Sue Ellen Francisco', cursive;\n  font-size: 20px;\n}\n\nform {\n  font-family: 'Sue Ellen Francisco', cursive;\n  font-size: 20px;\n  display: inline-block;\n  margin: 15px;\n  padding-top: 6px;\n  padding-bottom: 6px;\n  position: relative;\n  height: 3em;\n}\n\ninput[type=submit] {\n  background-color: #f7e3f3;\n  border: none;\n  padding: 7px;\n}\n\ninput {\n  padding: 7px;\n}\n", ""]);
